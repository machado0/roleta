...
function getRandomChampionByLane(lane) {
    const laneChampions = {
        ...
        support: [
            "Mel", "Heimerdinger", "Karma", "Zac", "Camille", "Malphite", "Pantheon", "Shen", "Tahm Kench", "Teemo", "Amumu", "Alistar", "Bard", "Blitzcrank", "Braum", "Galio", "Janna", "Leona", "Lulu", "Lux", "Milio", "Morgana", "Nami", "Nautilus", "Neeko", "Pyke", "Rakan", "Rell", "Renata Glasc", "Senna", "Seraphine", "Sona", "Soraka", "Swain", "Taric", "Thresh", "Twitch", "Vel'Koz", "Yuumi", "Zilean", "Zyra"
        ]
    };
